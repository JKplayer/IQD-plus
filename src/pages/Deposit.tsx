...
export default function Deposit() {
  // Use the admin phone number from the previous configuration
      ...
      <header className="space-y-4">
        <div>
          <h1 className="text-4xl font-black text-slate-900 dark:text-slate-100 tracking-tight leading-tight uppercase">
            Fuel Your <span className="text-emerald-600">Account</span>
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">
            Add Iraqi Dinar to your balance to start investing.
          </p>
        </div>
      </header>
      ...
      <div className="max-w-3xl">
        <Card className="border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 shadow-sm rounded-[2rem] overflow-hidden">
          <CardHeader className="p-8 pb-4">
            ...
            <CardTitle className="text-3xl font-black tracking-tight">Secure Deposit</CardTitle>
            <CardDescription className="text-slate-500 dark:text-slate-400 mt-2 text-base max-w-lg">
              To ensure the highest level of security and provide personalized assistance, all deposits are handled directly by our official support team.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8 pt-4 space-y-8">
            ...
            <div className="p-6 rounded-[1.5rem] bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/50 flex flex-col sm:flex-row gap-6 items-center">
               ...
               <div className="flex-1 text-center sm:text-left">
                 <h4 className="text-base font-black text-emerald-900 dark:text-emerald-100 tracking-tight mb-1">Instant Crediting</h4>
                 <p className="text-sm text-emerald-800/80 dark:text-emerald-300/80 font-medium leading-relaxed max-w-sm mx-auto sm:mx-0">
                   Once your transfer is verified by our admins via chat, your account balance will be credited instantly.
                 </p>
               </div>
            </div>
          </CardContent>
